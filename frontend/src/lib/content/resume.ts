...
export const resume: ResumeData = {
	...
	tagline:
		"Specializing in the intersection of high-scale cloud architecture, applied AI, and legal precision. Currently building the future of automotive finance at Ford Credit.",
	statement: [
		"Accomplished Software Engineer and Technical Lead with a proven record of orchestrating complex cloud migrations and architecting resilient microservices. My approach combines the rigorous logic of computer science with the meticulous precision required for legal practice.",
		"Presently advancing technical initiatives, exploring agentic AI systems, and pursuing the transition into legal counsel — bridging innovative technology, regulatory excellence, and the craft of clear thought.",
	],
	experience: [
		{
	...
	education: [
		{
			...
			concentration: "Minor in Mathematics | Concentration in Data Science",
			location: "Detroit, Michigan",
			period: "2017 - 2020",
		},
	],
	skills: {
		Languages: ["Java", "Python", "JavaScript", "TypeScript", "R", "C++", "Golang", "C"],
		Frameworks: [
			"React Native",
			"React",
			"Svelte",
